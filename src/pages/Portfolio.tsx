...
const portfolioItems = [
  // ---------------- Your Projects (with live preview) ----------------
  {
    title: "Darulquran Education System",
    category: "EdTech",
    description:
      "Built an online education platform with Quran courses, user dashboards, and payment integration.",
    image:
      "https://image.thum.io/get/width/800/crop/500/https://darulquraneducationsystem.com/",
  ...
  },
  {
    ...
    description:
      "Developed a travel and tours website for booking Umrah and international packages with dynamic content.",
    image:
      "https://image.thum.io/get/width/800/crop/500/https://globaltoursandumrah.com/",
  ...
  // ---------------- Demo/Dummy Projects ----------------
  {
    ...
    description:
      "Custom AI chatbot that reduced customer service workload by 70% and improved response times by 90%.",
    image:
  ...
  },
  {
    ...
    category: "Web Development",
    description:
      "Complete redesign and development of e-commerce platform resulting in 150% increase in conversions.",
    image:
  ...
  },
  {
    ...
    description:
      "Automated patient scheduling and record management system saving 25 hours per week.",
    image:
  ...
  },
  {
    ...
    description:
      "Built comprehensive analytics dashboard for SaaS company with real-time data visualization.",
    image:
  ...
  },
  {
    ...
    description:
      "AI-powered lead generation system with dynamic website that increased qualified leads by 300%.",
    image:
  ...
  },
  {
    ...
    category: "Custom Solutions",
    description:
      "Integrated POS and inventory management system across 15 restaurant locations.",
    image:
                ...
                <div className="grid grid-cols-3 gap-4 mb-6 p-4 rounded-lg bg-muted/30">
                  <div className="text-center">
                    <div className="text-sm font-bold text-primary">
                      {item.results.metric1.value}
                    </div>
                    <div className="text-xs text-muted-foreground">
                      {item.results.metric1.label}
                    </div>
                  </div>
                  <div className="text-center border-l border-r border-border/50">
                    <div className="text-sm font-bold text-secondary">
                      {item.results.metric2.value}
                    </div>
                    <div className="text-xs text-muted-foreground">
                      {item.results.metric2.label}
                    </div>
                  </div>
                  <div className="text-center">
                    <div className="text-sm font-bold text-accent">
                      {item.results.metric3.value}
                    </div>
                    <div className="text-xs text-muted-foreground">
                      {item.results.metric3.label}
                    </div>
                  </div>
                </div>
